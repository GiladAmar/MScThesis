...
\label{Chapter1EXAMPLE} % For referencing the chapter elsewhere, use \ref{Chapter1} 

\lhead{Chapter 1EXAMPLE. \emph{Chapter Title Here}} % This is for the header on each page - perhaps a shortened title
